...
import static com.github.watermelon.registry.zookeeper.Constant.ZK_CONNECTION_TIMEOUT;
...
public class ZooKeeperServiceRegistry implements ServiceRegistry {
    ...
    public ZooKeeperServiceRegistry(String zkAddress) {
        zkClient = new ZkClient(zkAddress, ZK_SESSION_TIMEOUT, ZK_CONNECTION_TIMEOUT);
